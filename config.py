...
OWNER_ID = int(os.environ.get("sitaratoons_support", "6692613520")) # Owner id
#--------------------------------------------
...
#--------------------------------------------
START_PIC = os.environ.get("START_PIC", "https://graph.org/file/b57518a5d140161cfae1a-167bee0051a025a35c.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://graph.org/file/25ecf90bfd9fde63b0418-c8e846722ab3c71d65.jpg")
...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @AcxAnimebackup</b>") #set your Custom Caption here, Keep None for Disable Custom Caption
...
QR_PIC = os.environ.get("QR_PIC", "https://graph.org/file/d71d50f68086bd63b2277-6a2c66ff2a02ff5982.jpg")
